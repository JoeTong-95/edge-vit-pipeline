...
Or from project root:
    python src/yolo-layer/test/test_yolo_layer.py --video data/sample.mp4
...
# Make sure imports work after this test moved under yolo-layer/test.
_TEST_DIR = os.path.dirname(os.path.abspath(__file__))
_YOLO_DIR = os.path.abspath(os.path.join(_TEST_DIR, ".."))
