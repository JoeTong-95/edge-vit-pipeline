...
Run from src/roi-layer:
    python .\visualize_roi_vlm.py --show
...
_VLM_DIR = _THIS_DIR.parent / "vlm-layer"
_CROPPER_DIR = _THIS_DIR.parent / "vlm-frame-cropper-layer"
_REPO_ROOT = _THIS_DIR.parent.parent
for path in (_THIS_DIR, _CONFIG_DIR, _INPUT_DIR, _YOLO_DIR, _VLM_DIR, _CROPPER_DIR):
    path_str = str(path)
